...
import { teses } from '../../../data/ListaPublicacoes';
...
function TeseListPage() {
  ...
  const sortPublicacoes = (teses: Tese[], sortBy: string) => {
    switch (sortBy) {
      ...
      case 'author':
        return teses.sort((a, b) => a.author.localeCompare(b.author));
      case 'year':
        return teses.sort((a, b) => b.year - a.year);
      case 'magazine':
        return teses.sort((a, b) => a.magazine.localeCompare(b.magazine));
      default:
        return teses;
    }
  };
